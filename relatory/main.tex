...
\item \textbf{Projeção final de textura} diretamente das bundles renderizadas.
\end{enumerate}
...
\item Execução em GPU de entrada é possível, porém lenta;
...
\item Integração com ControlNet;
\item Geração de normais em maior fidelidade;
\item Redução de tempo de inferência.
\end{itemize}
